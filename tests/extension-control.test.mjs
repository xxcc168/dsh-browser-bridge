...
function setup(saved={}) {
  ...
  const context={
    ...
    ws:{readyState:1},WebSocket:{OPEN:1},send:(_sock,msg)=>messages.push(msg),console,
  };
...
const lease={id:"lease-A",tabId:1,owner:"owner-A",agentName:"Task A",expiresAt:Date.now()+60000,state:"active"};
